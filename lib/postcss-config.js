...
module.exports = function(opt = {}) {
  ...
  return [
    ...
    !(opt['postcss-preset-env'] === false) && require('postcss-preset-env')({ stage: 0, preserve: true, ...opt['postcss-preset-env'] }),
    ...
    !(opt.purge === false) && require('./postcss-plugin-purgecss').postcssPlugin(opt.purge), //eslint-disable-line
