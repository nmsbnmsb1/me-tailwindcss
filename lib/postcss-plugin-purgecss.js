const postcssPurgeCssPlugin = require('@fullhuman/postcss-purgecss/lib/postcss-purgecss');
const { purgeTw, purgeVueTw } = require('./postcss-plugin-purgecss-extractor-tailwindcss');

let defaultOpts = {
  content: ['./public/**/*.html', './src/**/*.vue', './src/**/*.ts', './src/**/*.js', './examples/**/*.vue', './examples/**/*.ts', './examples/**/*.js'],
