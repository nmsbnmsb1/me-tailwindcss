...
// Default----------------------------------------------------------------------------------------------------------------
utils.pre = function (theme, prefix = 'tw-', separator = ':', important = false, target = 'relaxed', parentConfig = undefined) {
  if (!parentConfig) {
  ...
  //
  utils.config.prefix = prefix;
  utils.config.separator = separator;
  utils.config.important = important;
  utils.config.target = target;
  return utils.config;
};
