...
utils.variantsKeys = {
  ...
  backdropBrightness: 'backdropBrightness',
  backdropContrast: 'backdropContrast',
  backdropDropShadow: 'backdropDropShadow',
...
utils.varKeys = {
  ...
  [utils.keys.backdropBlur]: 'backdrop-blur',
  [utils.keys.backdropBrightness]: 'backdrop-brightness',
  [utils.keys.backdropContrast]: 'backdrop-contrast',
  [utils.keys.backdropGrayscale]: 'backdrop-grayscale',
  [utils.keys.backdropHueRotate]: 'backdrop-hue-rotate',
  [utils.keys.backdropInvert]: 'backdrop-invert',
  [utils.keys.backdropOpacity]: 'backdrop-opacity',
  [utils.keys.backdropSaturate]: 'backdrop-saturate',
  [utils.keys.backdropSepia]: 'backdrop-sepia',
  ...
  [utils.keys.blur]: 'blur',
  [utils.keys.brightness]: 'brightness',
  ...
  [utils.keys.dropShadow]: 'drop-shadow',
  [utils.keys.fill]: 'fill',
  [utils.keys.grayscale]: 'grayscale',
  [utils.keys.hueRotate]: 'hue-rotate',
  [utils.keys.invert]: 'invert',
  ...
  [utils.keys.saturate]: 'saturate',
  [utils.keys.scale]: 'scale',
  [utils.keys.sepia]: 'sepia',
...
// Default----------------------------------------------------------------------------------------------------------------
utils.pre = function (theme, options = {}, parentConfigPath = undefined) {
  if (!parentConfigPath) {
    utils.config = require('tailwindcss/resolveConfig')(require('lodash/cloneDeep')(require('tailwindcss/stubs/defaultConfig.stub.js')));
    utils.config.mode = 'jit';
    utils.config.purge = ['./public/**/*.html', './index.html', './src/**/*.{vue,js,ts,jsx,tsx}'];
    ...
    //
    let configFullPath = path.resolve(parentConfigPath);
    if (!fs.existsSync(configFullPath)) configFullPath = path.resolve('node_modules', parentConfigPath);
